...
SECRET_KEY = os.environ.get('SECRETS') or 'django-insecure-c32)-ovq#k_#d8a_csu-v$l6w0qvy)o#oly9*#v#vjx7pzf2r2'
...
# NOTE: This is the default setting for rest_framework
REST_FRAMEWORK = {
